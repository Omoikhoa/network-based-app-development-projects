...
const { validateId, validateManga, validateResult} = require('../middlewares/validator');
...
router.post('/', isLoggedIn, upload, validateManga, validateResult, controller.create);
...
router.put('/:id', validateId, isLoggedIn, isSeller, upload, validateManga, validateResult, controller.update);
